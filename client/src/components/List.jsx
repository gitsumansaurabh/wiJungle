...
const filters = [
  {
    ...
    name: "Event Type",
    options: [
      { value: "alert", label: "alert", checked: false },
      { value: "ssh", label: "ssh", checked: false },
      { value: "dns", label: "dns", checked: false },
      { value: "fileinfo", label: "fileinfo", checked: false },
    ...
    options: [
      {
        ...
        label: "Potentially Bad Traffic",
        checked: false,
      },
      {
        value: "Attempted Information Leak",
        label: "Attempted Information Leak",
        checked: false,
      },
      { value: "Misc Attack", label: "Misc Attack", checked: false },
      {
        value: "Not Suspicious Traffic",
        label: "Not Suspicious Traffic",
        checked: false,
      },
    ],
  },
